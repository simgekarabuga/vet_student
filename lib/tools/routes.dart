...
import 'package:vet_student/view/main_page.dart';
import 'package:vet_student/view/message_page.dart';
...
class Routes {
  ...
  static const String messagePageKey = '/message_page';
  ...
  static Map<String, WidgetBuilder> getRoutes() {
    return {
      ...
      messagePageKey: (BuildContext context) => ChangeNotifierProvider(
